...
async function route(){
  ...
  if(path==='/astronomi')return renderEntity({main,api,kind:'astronomy',title:'Astronomi',intro:'Observatorium, langit malam, star chart, dan pengamatan benda langit dalam pengalaman belajar Hogwarts.',finish,onRendered});
